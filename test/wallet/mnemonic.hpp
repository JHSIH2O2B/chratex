...
#ifndef CHRATEX_TEST_MNEMONIC_HPP
#define CHRATEX_TEST_MNEMONIC_HPP
...
struct mnemonic_result {
  ...
  std::string seed;
  chratex::wallet::dictionary language;
};
...
{
  {
    ...
    },
    {
      ...
      "",
      "",
      chratex::wallet::language::zh_Hans
    },
    {
      "baadf00dbaadf00dbaadf00dbaadf00d",
      "博 肉 地 危 惜 多 陪 荒 因 患 伊 基",
      "",
      "",
      chratex::wallet::language::zh_Hant
    }
  }
};
